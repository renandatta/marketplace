...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-0">
                <div class="col-md-10">
                    <form action="{{ route('management.courier.search') }}" method="post" id="form_search">
                        @csrf
                ...
                <div class="col-md-2">
                    <div class="form-group mb-0">
                        <label>&nbsp;</label>
                        <a href="{{ route('management.courier.info') }}" class="btn btn-primary btn-block">Tambah</a>
                    </div>
                </div>
            </div>
            <hr>
...
@push('scripts')
    <script>
        ...
        $('#form_search').submit(function (e) {
            ...
            $.post("{{ route('management.courier.search') }}?page=" + selectedPage, {
                _token: '{{ csrf_token() }}',
